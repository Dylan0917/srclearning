package com.yu.core.bean;

import com.yu.core.bean.BeanDesc.PropDesc;
import com.yu.core.bean.copier.BeanCopier;
import com.yu.core.bean.copier.CopyOptions;
import com.yu.core.bean.copier.ValueProvider;
import com.yu.core.collection.CollUtil;
import com.yu.core.convert.Convert;
import com.yu.core.lang.Editor;
import com.yu.core.lang.Filter;
import com.yu.core.map.CaseInsensitiveMap;
import com.yu.core.map.MapUtil;
import com.yu.core.util.ArrayUtil;
import com.yu.core.util.ClassUtil;
import com.yu.core.util.ModifierUtil;
...
public class BeanUtil {
	 ...
	 * 如果isSimple为{@code false}，则只匹配类名而忽略包名，例如：com.yu.TestEntity只匹配TestEntity<br>
	 * 如果isSimple为{@code true}，则匹配包括包名的全类名，例如：com.yu.TestEntity匹配com.yu.TestEntity
	 *
	 * @param bean          Bean
