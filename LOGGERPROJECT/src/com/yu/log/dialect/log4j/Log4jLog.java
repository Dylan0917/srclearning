package com.yu.log.dialect.log4j;

import org.apache.log4j.Level;
import org.apache.log4j.Logger;

import com.yu.core.util.StrUtil;
import com.yu.log.AbstractLog;
...
public class Log4jLog extends AbstractLog {
	...
	public void trace(String fqcn, Throwable t, String format, Object... arguments) {
		log(fqcn, com.yu.log.level.Level.TRACE, t, format, arguments);
	}
	...
	public void debug(String fqcn, Throwable t, String format, Object... arguments) {
		log(fqcn, com.yu.log.level.Level.DEBUG, t, format, arguments);
	}
	// ------------------------------------------------------------------------- Info
	@Override
	...
	public void info(String fqcn, Throwable t, String format, Object... arguments) {
		log(fqcn, com.yu.log.level.Level.INFO, t, format, arguments);
	}
	...
	public void warn(String fqcn, Throwable t, String format, Object... arguments) {
		log(fqcn, com.yu.log.level.Level.WARN, t, format, arguments);
	}
	...
	public void error(String fqcn, Throwable t, String format, Object... arguments) {
		log(fqcn, com.yu.log.level.Level.ERROR, t, format, arguments);
	}

	// ------------------------------------------------------------------------- Log
	@Override
	public void log(String fqcn, com.yu.log.level.Level level, Throwable t, String format, Object... arguments) {
		Level log4jLevel;
		switch (level) {
			case TRACE:
